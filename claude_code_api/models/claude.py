...
def validate_claude_model(model: str) -> str:
    ...
    # Check if it's a provider-specific model (like kimi models)
    # For now, just return the model as-is for provider-specific models
    # The provider system will handle the mapping
    return model
