...
from claude_code_api.models.providers import get_provider_info, get_supported_models
...
async def get_providers():
    ...
    return {
        ...
        "total_providers": len(get_provider_info()),
        "total_models": len(get_supported_models())
    }
